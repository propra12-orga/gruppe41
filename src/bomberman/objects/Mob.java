...
/**
 * Subclass of movable, subclass of map object. Players are objects of this type. This class only sets the render priority to 2.
 * 
...
{
	/**
	 * Calls up the super constructor movable and sets the render priority to 2.
	 * 
	 * @param map - The map where this object has to be added to.
