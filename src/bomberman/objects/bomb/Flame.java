...
public class Flame extends MapObject
{
	 ...
	 * @param type - The type determines how the flame is painted (for example zero is the center of an explosion, four the top edge)
	 */
	public Flame(Map map, int tile_x, int tile_y, int type)
	{
		super(map, tile_x, tile_y);

		img = new Animation(Image.read("data/sprites/flames.png"), 0, type, Map.TILE_SIZE, Map.TILE_SIZE, 12, 50, false);
	}

	/**
	 * Update method for flames. The animation is updated and the flames are removed is necessary.
	 */
	public void Update()
	{
		img.Update();
	...
	/**
	 * This method calls up "onHurt" method for any map object touching the flame. Players die, other bombs will blow up.
	 */
