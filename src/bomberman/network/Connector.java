...
public abstract class Connector implements Input, Connection {
	...
	/**
	 * Status: 0 = not active (object could not be created), 1 = active, but not
	 * connected (server only) or found server who didn't answer, 2 = connected,
	 * but client not ready, 3 = ready to start the game, 3 = playing.
	 */
