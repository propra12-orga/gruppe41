...
public abstract class Powerup extends MapObject {
	...
	/**
	 * The animation shown whenever an instance of a subclass is shown on the
	 * map.
	 */
	protected Animation img;

	/**
	 * Constructor will be used by subclasses. Calls up super constructor in map
	 * object class.
	 * 
	 * @param map
	...
	/**
	 * Method will be used when a player picks up the item. The item is removed
	 * and the pickup sound will be played. This method is called up by the
	 * onTouch method of the subclasses.
	 */
