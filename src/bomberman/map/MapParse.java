...
public class MapParse
{
	 ...
	 * @param blocks - String in the input file, contains a '1' for every wall.
	 */
	...
	/**
	 * This method randomly generates rocks on the whole map. There won't be any rocks placed onto spawn points or walls.
	 * 
	 * @param probability - The chance to generate a rock at any position.
	 */
