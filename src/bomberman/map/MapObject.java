...
/**
 * Abstract class. The following classes (and their subclasses) are subclasses of MapObject:
 * 
...
public abstract class MapObject
{
	 ...
	 * 
	 * @param map - The map the object has to be added to.
	...
	{
		g.drawImage(img, x, y, x + WIDTH, y + HEIGHT, sprite_x * WIDTH, sprite_y * HEIGHT, sprite_x * WIDTH + WIDTH, sprite_y * HEIGHT + HEIGHT, null);
	}
	...
	/**
	 * This method return a boolean, true if another movable cannot move through it, false if it is possible.
	 * 
	...
	/**
	 * This method will be overridden in subclasses. Tells what to do when getting in contact with a movable.
	 * 
	 * @param m - The movable touching the map object.
	 * @param side - The direction/side of touching.
	 */
	...
	/**
	 * This method will be overwritten in subclasses. Tells what to do when colliding with a movable map object.
	 * 
	 * @param m
	 * @param side
	 */
	...
	/**
	 * Tells what to do when colliding with a explosion flame. Will be overwritten in subclasses. For example players die, bombs are activated, rocks are destroyed, blocks ignore this.
	 */
	public void OnHurt()
	{
